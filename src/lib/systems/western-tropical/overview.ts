...
export const overview: SystemOverview = {
  ...
  stats: {
    ...
    dominant: "Your overall signature in one line: the element, modality, and polarity your chart leans toward.",
    sect: "Whether you were born by day or by night, which sets the tone of the chart and which light leads it.",
    triplicity: "The classical ruler of your Sun's element, the planet that takes charge of that part of you.",
    decan: "The ten degree slice of the sign your Sun sits in, with its older planetary face, a finer shade of your solar nature.",
    "chart-ruler": "The classical ruler of your rising sign, a planet that speaks for the whole chart, shown with where it sits.",
    "chart-shape": "Where the weight of your chart gathers: above or below the horizon, toward self or others, and whether it drives, holds, or adapts.",
