...
export const overview: SystemOverview = {
  ...
  stats: {
    ...
    birthday:
      "The day of the month you were born, reduced: a gift you carry and reach for naturally.",
    attitude:
      "Drawn from your month and day together: how you tend to meet a new day and first come across.",
    maturity:
