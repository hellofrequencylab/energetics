...
alter table energetics.system_settings alter column enabled drop not null;
alter table energetics.system_settings add column if not exists sort_order integer;
